...
function statusBadge(used: number, limit: number) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Consumption for {period && <span className="font-medium">{period}</span>} — one row per user × model that ran
          something. Usage is read-only; adjust caps in the Users or Model-defaults tabs.
        </p>
